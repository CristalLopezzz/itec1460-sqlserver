...
-- in both tables (primary key in customers and the foreign key in orders)
...
-- Part 3: Shows total revenue for each customer in 1997 and how many orders they placed
SELECT TOP 10 
o.CustomerID,
